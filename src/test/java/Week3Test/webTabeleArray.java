...
public class webTabeleArray extends BaseClass   {
    /*
...
//        Add 10 records.
        ...
        for (int i = 1; i <= 10; i++) {
            ...
            ageInput.sendKeys(String.valueOf(faker.number().numberBetween(5,99)));
//                select.selectByIndex(faker.internet().numberBetween(1,5));
