...
public class C35_fileUploadTest extends BaseClass {
    @Test
    void fileUploadTest() {
        driver.get("https://claruswaysda.github.io/downloadUpload.html");

        WebElement singleFileUpload = driver.findElement(By.id("uploadInput"));;
        singleFileUpload.sendKeys(System.getProperty("user.dir")+"files/doc01.pdf");
...
//        Verify that 'Please upload at least one PDF file. Only PDF files are allowed!'
        ...
        WebElement singleFileUpload = driver.findElement(By.id("uploadInput"));;
        singleFileUpload.sendKeys(System.getProperty("user.dir")+"files/test_doc.txt");
        driver.findElement(By.xpath("//*[.='Submit']")).click();
